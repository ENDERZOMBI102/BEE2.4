...
from typing import (
	...
	KeysView, ValuesView, ItemsView, Dict,
)
...
wxFonts = Dict[str, wx.Font]


def CreateFonts():
	global wxFonts
	wxFonts = {
		'Helvetica': wx.Font( wx.FontInfo(12).FaceName("Helvetica") ),
		'DIN': wx.Font( wx.FontInfo(12).FaceName("DIN") ),
		'Times': wx.Font( wx.FontInfo(12).FaceName("Times") )
	}
